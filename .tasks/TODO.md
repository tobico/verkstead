...
- [ ] 01: The share comment stops triggering Wrapping — [details](01-share-comment-marker.md)
- [ ] 02: Ignore rules live in the settings and round-trip the API — [details](02-ignore-rules-setting.md)
- [ ] 03: Wrapping skips ignored comments everywhere it reads them — [details](03-wrapping-skips-ignored.md)
