...
- [ ] 01: The crate, the server in-process, and the browser — [details](01-crate-server-and-browser.md)
- [ ] 02: The tray icon, Open and Exit — [details](02-tray-open-and-exit.md)
