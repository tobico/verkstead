...
- [x] 05: A session runs inside an Apple sandbox — [details](05-session-in-an-apple-sandbox.md)
- [x] 06: HOME, the account and the skills — [details](06-home-account-and-skills.md)
- [x] 07: Companions, configured binds and the build cache — [details](07-companions-binds-and-cache.md)
- [x] 08: A session outlives nothing — [details](08-a-session-outlives-nothing.md)
- [x] 09: The install story — [details](09-install-story.md)
