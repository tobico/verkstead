...
- [x] 04: Grilling session with a captured transcript — [details](04-grilling-session.md)
- [x] 05: Bundled skills — [details](05-bundled-skills.md)
- [x] 06: Question Sets in the Timeline — [details](06-question-sets-in-the-timeline.md)
- [x] 07: Retire the pending and archive namespaces — [details](07-retire-pending-and-archive.md)
