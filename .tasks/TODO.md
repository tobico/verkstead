...
- [x] 03: Run the Windows suite through cargo-nextest — [details](03-nextest.md)
- [x] 04: Measure against Linux parity, shard only if needed — [details](04-measure-and-shard.md)
