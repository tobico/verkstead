...
//! pane draws:
//!
//! - `github`, `build-cache`, `share-viewer` and `conflicts` — the
//!   credentials, the shared Rust build cache, where the share viewer is hosted
//!   and how a conflicted pull request is resolved, each named by a word. There
//!   is one of each of them, and a word says so.
...
/// shared Rust build cache, where the share viewer is hosted and how a
