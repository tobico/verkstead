...
/// The row that runs nothing comes back as itself: whether a fresh Repo takes a
/// skip across is decided above the store, which has to be told there was one to
/// decide it.
#[tokio::test]
