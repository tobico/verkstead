...
//! watching.
//!
//! Nothing here creates a branch, a worktree or a session. A Conversation is a
//! record of work to be started later, and the whole of what this stage does
//! with it is let the human get it right first.

use std::path::Path;

use anyhow::Result;
use sqlx::SqlitePool;
use verkstead_render::{BaseRecorded, BranchRenamed, BriefSaved, Started};
