...
Then read what the repository says about itself — its `CLAUDE.md` or
`AGENTS.md`, its `docs/`, the tests around what you are changing — and work the
way it does. Match what is around the change, and prefer the smallest thing
that does the job.
