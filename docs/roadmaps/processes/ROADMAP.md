...
- [ ] 01: Process on the record — [brief](01-process-on-the-record.md) *(in progress: `roadmaps/processes/01-process-on-the-record`)*
- [ ] 02: The Agent control — [brief](02-the-agent-control.md)
- [ ] 03: Tinker, and No grilling retires — [brief](03-tinker.md)
